...
class InstancesControllerTest < ActionController::TestCase
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post :create, instance: { activity_id: @instance.activity_id, private: @instance.private, until: @instance.until, when: @instance.when }
    end
  ...
  test "should update instance" do
    patch :update, id: @instance, instance: { activity_id: @instance.activity_id, private: @instance.private, until: @instance.until, when: @instance.when }
    assert_redirected_to instance_path(assigns(:instance))
  end
